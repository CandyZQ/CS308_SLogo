...
public class TurtleTest {
    ...
    /**
     * Tests overloaded method setHeading correctly sets heading for input argument
     * and correctly returns rotation value
     */
    @Test
    public void shouldSetHeading() {
        ...
        Assert.assertTrue((double) turtle.getState().get(MovingObjectProperties.HEADING) > (expd*.99D) && (double) turtle.getState().get(MovingObjectProperties.HEADING) < (expd*1.01D));
        set_X = 0D;
        set_Y = 1D;
        expd = 90D;
        turtle.setHeading(set_X,set_Y);
    ...
    public void shouldMoveDistance() {
        ...
        Assert.assertTrue((double) turtle.getState().get(MovingObjectProperties.X) > (expd*.99D) && (double) turtle.getState().get(MovingObjectProperties.X) < (expd*1.01D));
        Assert.assertTrue((double) turtle.getState().get(MovingObjectProperties.Y) > (expd*.99D) && (double) turtle.getState().get(MovingObjectProperties.Y) < (expd*1.01D));
